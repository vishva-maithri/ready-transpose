...
export default function App(){
  ...
  return <main className="app-shell">
    ...
    <section className="player-card">
      ...
      <div className="pitch-panel"><div className="pitch-heading"><div><span className="label">TRANSPOSE</span><div className="pitch-value">{pitch>0?'+':''}{pitch}<small> semitones</small></div><span className="keyboard-hint">↑ ↓ to transpose</span></div><button className="reset" onClick={()=>changePitch(0)} disabled={loading||pitch===0}>Reset</button></div>
